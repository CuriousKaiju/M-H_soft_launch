...
public class DragAndDrop : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource _emptyDropSound;
    [SerializeField] private AudioSource _disable;
    [SerializeField] private AudioSource _merge;
    [SerializeField] private AudioSource _swap;
        ...
        if (Physics.Raycast(ray, out hit, 100, _platformLayer))
        {
            ...
            else if (!selectedPlatform._isPlatformFree)
            {
                ...
                else
                {
                    ...
                    //newAnimalPlatform.ActivateInit();
    ...
    private void HitRayAndTryToBuyPlatform()
    {
        ...
        if (Physics.Raycast(ray, out hit, 100, _platformLayer))
        {
            ...
            {
                selectedPlatform.TryToBuyPlatform(_sceeControllern._currentMeatCount, out status);
